 ...
 * @method TraderQuery filterByCurrencyId($value, $criteria = null)
 ...
 * @method TraderQuery filterByStatus($value, $criteria = null)
  ...
  * @method TraderQuery orderByCurrencyId($order = Criteria::ASC)
  ...
  * @method TraderQuery withCurrency($params = [])
  * @method TraderQuery joinWithCurrency($params = null, $joinType = 'LEFT JOIN')
